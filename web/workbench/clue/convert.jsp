        ...
        $(function () {
            ...
            $("#convertBtn").click(function () {
                ...
                //提交表单
                    ...
                    alert("不需要创建交易")
                    window.location.href="workbench/clue/concert.do?clueId=${param.id}";
...
<div id="create-transaction2"
    ...
    <form id="tranForm" action="workbench/clue/concert.do" method="post">
