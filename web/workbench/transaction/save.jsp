...
//为查找市场活动放大镜图标绑定事件，打开搜索市场活动的模态窗口
            ...
            //为查找联系人放大镜图标绑定事件，打开搜索联系人的模态窗口
            $("#openContactsModalBtn").click(function () {
                $("#aContactsName").keydown(function (event) {
                    if (event.keyCode == 13) {
                        $.ajax({
                            url: "workbench/transaction/getContactsListByName.do",
                            type: "GET",
                            data: {
                                "aContactsName": $.trim($("#aContactsName").val())
                            },
                            dataType: "json",
                            success: function (data) {
                                var html = "";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input id="aContactsName" type="text" class="form-control" style="width: 300px;"
...
<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <label for="create-expectedClosingDate" class="col-sm-2 control-label">预计成交日期<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" name="expectedDate" class="form-control time1" id="create-expectedClosingDate">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);"id="openSearchModalBtn"><span
