<%@ page import="com.biao.crm.pojo.DicValue" %>
<%@ page import="com.biao.crm.workbench.pojo.Tran" %>
...
<%
    ...
    for (int i = 0; i < dvList.size(); i++) {
        ...
        if ("0".equals(possibility)) {
            //如果可能性为0 ，说明找到了前面正常阶段和后面非正常阶段的分界点
            point = i;
            break;
        }
    }
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function changStage(stage, i) {
            $.ajax({
                url: "workbench/transaction/changStage.do",
                type: "GET",
                data: {
                    "id": "${t.id}",
                    "stage": stage,
                    "money": "${t.money}",//生成交易历史
...
<div style="position: relative; left: 40px; top: -30px;">
    <div class="page-header">
        <h3>${t.contactsId}-${t.name}<small>$${t.money}</small></h3>
    </div>
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
        ...
        //判断当前阶段
        //如果当前阶段可能性为0，前七个一定是黑圈，后两个一定是一个红叉，一个黑叉
...
//黑叉
    ...
    //如果当前阶段可能性不为0，前7个有可能是绿圈，绿色标记，黑圈，后面两个一定是黑叉
    else {
        //准备当前阶段下标
        int index = 0;
        for (int i = 0; i < dvList.size(); i++) {
...
<div style="position: relative; top: 0px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 10px;">
        ...
        <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${t.contactsId}-${t.name}</b></div>
